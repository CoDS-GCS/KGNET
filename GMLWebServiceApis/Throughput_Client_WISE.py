...
url = "http://localhost:7770/fullbatch_wise/mid/example_model_id"

dblp = {"dataset_name": "DBLP_D1H1", }
file_path_dblp = os.path.join(KGNET_Config.datasets_output_path,'targets','DBLP_D1H1','DBLP_D1H1_1600.csv')

mag = {"dataset_name": "MAG_D1H1", }
file_path_mag = os.path.join(KGNET_Config.datasets_output_path,'targets','MAG_D1H1','MAG_D1H1_1600.csv')

yago = {"dataset_name": "YAGO_PC_D1H1_v2"}
file_path_yago = os.path.join(KGNET_Config.datasets_output_path,'targets','YAGO_PC_D1H1_v2','YAGO_PC_D1H1_v2_1600.csv')
