...
from GMLOperators import GML_Insert_Operator
...
if __name__ == '__main__':
    ...
    LinkedIMDB_Insert_Query = """
               ...
               where{
                   ...
                   "GMLTask":{
                       ...
                       "datasetTypesFilePath":\""""+KGNET_Config.datasets_output_path+"""LinkedIMDB_Types.csv",
    ...
    gml_insert_op=GML_Insert_Operator(kgmeta_govener,KG_sparqlEndpoint)
