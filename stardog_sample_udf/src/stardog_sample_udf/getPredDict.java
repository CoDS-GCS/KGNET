...
public class getPredDict extends AbstractExpression implements StringFunction
{
 public getPredDict() {
...
//     super(2, new String[] { "getPredDict", "kgnet.getPredDict", "tag:stardog:api:kgnet:getPredDict" });
 ...
 public getPredDict(final Expression theLeft, final Expression theRight) {
     this();
     this.mArgs = Lists.newArrayList(new Expression[] { theLeft, theRight });
 }
 
 private getPredDict(final getPredDict theExpr) {
     super((AbstractExpression)theExpr);
 }
 
 public String getName() {
     return "tag:stardog:api:kgnet:getPredDict";
 }
 ...
 public Function copy() {
     return (Function)new getPredDict(this);
 }
 ...
 public ValueOrError evaluate(final ValueSolution theValueSolution) {
	 System.out.print("getPredDict Called");
     ...
     final String toSplit = ((Literal)arg0.value()).label();
     final String splitBy = ((Literal)arg2.value()).label();
     int limit = 0;
     if (args.size() == 3) {
...
//         return ValueOrError.General.of((Value)new ArrayLiteral(ids));
     	...
     	String res=HTTP_Request.dopost_jsonString(url,json);
     	System.out.println("Pred JSON Res="+res);
...
//        return ValueOrError.General.of((Value)new ArrayLiteral(res));
 ...
 public static void main(String[] args) {
	 System.out.print("Call To getPredDict");
