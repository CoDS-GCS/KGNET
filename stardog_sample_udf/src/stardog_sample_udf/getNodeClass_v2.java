...
public class getNodeClass_v2 extends AbstractExpression implements StringFunction
{
 public getNodeClass_v2() {
     super(new Expression[0]);
//     super(2, new String[] { "getPredDict", "kgnet.getPredDict", "tag:stardog:api:kgnet:getPredDict" });
 }
 
 public getNodeClass_v2(final Expression theLeft, final Expression theRight) {
     this();
     this.mArgs = Lists.newArrayList(new Expression[] { theLeft, theRight });
 }
 
 private getNodeClass_v2(final getNodeClass_v2 theExpr) {
     super((AbstractExpression)theExpr);
 }
 
 public String getName() {
     return "tag:stardog:api:kgnet:getNodeClass_v2";
 }
 ...
 public Function copy() {
     return (Function)new getNodeClass_v2(this);
 }
 ...
 public ValueOrError evaluate(final ValueSolution theValueSolution) {
	 System.out.print("getNodeClass_v2 Called");
...
//     	String url="http://206.12.99.65:64647/gml_inference/mid/92";
     	...
     	System.out.println("getNodeClass_v2 Res="+res);
...
//        return ValueOrError.General.of((Value)new ArrayLiteral(res));
 ...
 public static void main(String[] args) {
	 System.out.print("Call To getNodeClass_v2");
